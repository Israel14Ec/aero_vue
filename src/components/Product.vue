<template>
    <li 
        :class="{'opacity-30': isProductNoAvailability}"
        class="flex ietms-center space-x-6 order border-gray-200 p-6 bg-white shadow"
    >
        <img
            :src="product.image"
            :alt="product.name"
...
import { PiniaVuePlugin } from 'pinia';
    ...
    //Mediante props tengo los datos de los productos
    ...
    const isProductNoAvailability = computed (()=> props.product.availability === 0)
